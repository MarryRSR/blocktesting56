# blocktesting56
Blocktesting56 is a collection of utilities for interacting with Web3 and Ethereum smart contracts.
...
```bash
npm install blocktesting56
```
## Usage

const Web3Tools = require('blocktesting56');
